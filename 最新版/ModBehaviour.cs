// ------------------------------------------------------------------
// AddBuffMod - 【V3.6 - “九龙拉棺”Buff 组合现在完全可自定义 // 修复“热血针剂”Bug】
...
namespace AddBuffMod
{
    ...
    {
        // ModConfig 名称
        public static string MOD_NAME = "九龙拉棺Mod[一键上buff]v3.6"; // [V3.6] 更新版本号
        ...
        // 九龙拉棺专用的 Buff 列表 (现在由 ModConfig 动态填充)
        ...
        private void TryRegisterConfig()
        {
            ...
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_1", "  [九龙] 包含 Buff 1 [缓疗]", true);
            // --- Buff 2 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey2", "Buff 2 [加速] Key", typeof(string), "Alpha2", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_2", "  [九龙] 包含 Buff 2 [加速]", true);
            // --- Buff 3 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey3", "Buff 3 [强翅] Key", typeof(string), "Alpha3", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_3", "  [九龙] 包含 Buff 3 [强翅]", true);
            // --- Buff 4 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey4", "Buff 4 [负重] Key", typeof(string), "Alpha4", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_4", "  [九龙] 包含 Buff 4 [负重]", true);
            // --- Buff 5 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey5", "Buff 5 [护甲] Key", typeof(string), "Alpha5", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_5", "  [九龙] 包含 Buff 5 [护甲]", true);
            // --- Buff 6 [V3.6 修复] ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey6", "Buff 6 [易怒] Key", typeof(string), "Alpha6", null); //
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_6", "  [九龙] 包含 Buff 6 [易怒]", true); //
            // --- Buff 7 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey7", "Buff 7 [镇静] Key", typeof(string), "Alpha7", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_7", "  [九龙] 包含 Buff 7 [镇静]", true);
            // --- Buff 8 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey8", "Buff 8 [明视] Key", typeof(string), "Alpha8", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_8", "  [九龙] 包含 Buff 8 [明视]", true);
            // --- Buff 9 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey9", "Buff 9 [持久] Key", typeof(string), "Alpha9", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_9", "  [九龙] 包含 Buff 9 [持久]", true);

            // --- 九龙拉棺热键 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "NineDragonsKey", "【九龙拉棺】(激活) Key", typeof(string), "Alpha0", null);

            // --- Buff 10 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey10", "Buff 10 [电抗] Key", typeof(string), "None", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_10", "  [九龙] 包含 Buff 10 [电抗]", false);
            // --- Buff 11 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey11", "Buff 11 [近战] Key", typeof(string), "None", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_11", "  [九龙] 包含 Buff 11 [近战]", false);
            // --- Buff 12 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey12", "Buff 12 [火抗] Key", typeof(string), "None", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_12", "  [九龙] 包含 Buff 12 [火抗]", false);
            // --- Buff 13 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey13", "Buff 13 [毒抗] Key", typeof(string), "None", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_13", "  [九龙] 包含 Buff 13 [毒抗]", false);
            // --- Buff 14 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey14", "Buff 14 [空间抗] Key", typeof(string), "None", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_14", "  [九龙] 包含 Buff 14 [空间抗]", false);
            // --- Buff 15 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey15", "Buff 15 [止血] Key", typeof(string), "None", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_15", "  [九龙] 包含 Buff 15 [止血]", false);
            // --- Buff 16 ---
            ModConfigAPI.SafeAddInputWithSlider(MOD_NAME, "BuffKey16", "Buff 16 [弱效空间抵抗] Key", typeof(string), "None", null);
            ModConfigAPI.SafeAddBoolDropdownList(MOD_NAME, "NineDragonsInclude_16", "  [九龙] 包含 Buff 16 [弱效空间]", false);
        ...
        {
            _buffKeyMap.Clear();
            _nineDragonsBuffNames.Clear(); // <-- 【重要】在这里清空列表
            ...
            // --- 【核心修改】加载热键并动态构建九龙列表 ---
            string buffName; // 声明一个临时变量

            buffName = "1018_Buff_HealForWhile";
            LoadAndMapKey("BuffKey1", "Alpha1", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_1", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1011_Buff_AddSpeed";
            LoadAndMapKey("BuffKey2", "Alpha2", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_2", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1017_Buff_InjectorRecoilControl";
            LoadAndMapKey("BuffKey3", "Alpha3", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_3", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1012_Buff_InjectorMaxWeight";
            LoadAndMapKey("BuffKey4", "Alpha4", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_4", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1013_Buff_InjectorArmor";
            LoadAndMapKey("BuffKey5", "Alpha5", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_5", true))
                _nineDragonsBuffNames.Add(buffName);

            // [V3.6 修复]
            buffName = "1092_Buff_Injector_HotBlood_Trigger";
            LoadAndMapKey("BuffKey6", "Alpha6", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_6", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1084_Buff_PainResistLong";
            LoadAndMapKey("BuffKey7", "Alpha7", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_7", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1201_Buff_NightVision";
            LoadAndMapKey("BuffKey8", "Alpha8", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_8", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1014_Buff_InjectorStamina";
            LoadAndMapKey("BuffKey9", "Alpha9", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_9", true))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1072_Buff_ElecResistShort";
            LoadAndMapKey("BuffKey10", "None", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_10", false))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1015_Buff_InjectorMeleeDamage";
            LoadAndMapKey("BuffKey11", "None", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_11", false))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1074_Buff_FireResistShort";
            LoadAndMapKey("BuffKey12", "None", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_12", false))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1075_Buff_PoisonResistShort";
            LoadAndMapKey("BuffKey13", "None", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_13", false))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1076_Buff_SpaceResistShort";
            LoadAndMapKey("BuffKey14", "None", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_14", false))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1019_buff_Injector_BleedResist";
            LoadAndMapKey("BuffKey15", "None", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_15", false))
                _nineDragonsBuffNames.Add(buffName);

            buffName = "1113_Buff_StormProtection1";
            LoadAndMapKey("BuffKey16", "None", buffName);
            if (ModConfigAPI.SafeLoad<bool>(MOD_NAME, "NineDragonsInclude_16", false))
                _nineDragonsBuffNames.Add(buffName);
            ...
            Debug.Log($"[{MOD_NAME}] 已加载九龙拉棺自定义组合，共 {_nineDragonsBuffNames.Count} 个 Buff。");
            LogModInfo();
        }
        ...
        private void InitializeBuffItemMap()
        {
            ...
            _buffItemMap["1013_Buff_InjectorArmor"] = 797;
            _buffItemMap["1092_Buff_Injector_HotBlood_Trigger"] = 438; // [V3.6 修复] 
            ...
            _buffItemMap["1113_Buff_StormProtection1"] = 856;
        }
        ...
        private void InitializeItemIdToBuffMap()
        {
            ...
            // 【V3.6 热血Bug修复】手动添加“热血”的触发器和效果Buff，确保它们被缓存
            // 我们用负数作为假ID，确保不和任何物品ID冲突，目的只是为了让 CacheBuffPrefabsAsync() 找到它们的名字
            if (!_itemIdToBuffNameMap.ContainsValue("1091_Buff_HotBlood"))
                _itemIdToBuffNameMap[-1] = "1091_Buff_HotBlood";
            if (!_itemIdToBuffNameMap.ContainsValue("1093_Buff_Injector_HotBlood_SpeedDamage"))
                _itemIdToBuffNameMap[-2] = "1093_Buff_Injector_HotBlood_SpeedDamage";
        ...
        private void InitializeNameMaps()
        {
            ...
            _buffDragonNames["1092_Buff_Injector_HotBlood_Trigger"] = "康复龙"; // [V3.6 修复]
            ...
            _buffDragonNames["1113_Buff_StormProtection1"] = "风暴保护龙1";
            ...
            _buffChineseNames["1092_Buff_Injector_HotBlood_Trigger"] = "易怒"; // [V3.6 修复] 这是热血针的“触发器”Buff
            _buffChineseNames["1093_Buff_Injector_HotBlood_SpeedDamage"] = "愤怒"; // [V3.6 修复] 这是热血针的“效果”Buff
            ...
            _buffChineseNames["1113_Buff_StormProtection1"] = "风暴防护1";
            ...
            _buffItemChineseNames["1092_Buff_Injector_HotBlood_Trigger"] = "热血针剂"; // [V3.6 修复]
        ...
        private void InitializeBuffHotkeys()
        {
            ...
            _buffKeyMap[KeyCode.Alpha6] = "1092_Buff_Injector_HotBlood_Trigger"; // [V3.6 修复]
            ...
            // 【重要】在没有 ModConfig 时，也要填充默认的九龙列表
            ...
            _nineDragonsBuffNames.Add("1092_Buff_Injector_HotBlood_Trigger"); // [V3.6 修复]
        ...
        private async UniTask CacheBuffPrefabsAsync()
        {
            ...
            try
            {
                ...
                // [V3.6 修复] 检查热血三件套是否都已缓存
                if (_buffPrefabCache.ContainsKey("1091_Buff_HotBlood")) Debug.Log($"[{MOD_NAME}] [HotBlood Fix] Cached: 1091_Buff_HotBlood");
                if (_buffPrefabCache.ContainsKey("1092_Buff_Injector_HotBlood_Trigger")) Debug.Log($"[{MOD_NAME}] [HotBlood Fix] Cached: 1092_Buff_Injector_HotBlood_Trigger");
                if (_buffPrefabCache.ContainsKey("1093_Buff_Injector_HotBlood_SpeedDamage")) Debug.Log($"[{MOD_NAME}] [HotBlood Fix] Cached: 1093_Buff_Injector_HotBlood_SpeedDamage");
        ...
        private async UniTask TriggerNineDragonsCoffinAsync()
        {
            ...
            try
            {
                ...
                if (_nineDragonsBuffNames == null || _nineDragonsBuffNames.Count == 0)
                {
                    Debug.LogWarning($"[{MOD_NAME}] NineDragons triggered, but no buffs are selected in ModConfig.");
                    ShowBubbleAsync(mainCharacter.transform, "九龙拉棺失败: 未配置任何 Buff", 2f).Forget();
                    return;
                }
                ...
                {
                    Debug.Log($"[{MOD_NAME}] Hardcore check for NineDragons (Checking {_nineDragonsBuffNames.Count} buffs)...");
                    foreach (string buffName in _nineDragonsBuffNames)
                    {
                        if (!_buffItemMap.TryGetValue(buffName, out int itemID) || itemID <= 0) continue;

                        var findResult = await FindAndConsumeHardcoreItemAsync(itemID, mainCharacter, false);
                        if (!findResult.Item1)
                        {
                        ...
                        itemsToConsumeDetails.Add((findResult.Item3, findResult.Item2));
                    }
                ...
                Debug.Log($"[{MOD_NAME}] Triggering [NineDragons], activating {_nineDragonsBuffNames.Count} buffs...");
                ...
                foreach (string buffName in _nineDragonsBuffNames)
                {
                    ...
                    // [V3.6 修复] 确保所有Buff（包括1113和1092）都能正确获取
                    if (!_buffPrefabCache.TryGetValue(buffName, out buffPrefab))
                    {
                        // 如果缓存失败，尝试实时查找
                        Debug.LogWarning($"[{MOD_NAME}] (NineDragons) Buff '{buffName}' not in cache, attempting fallback scan...");
                    ...
                    if (buffPrefab != null)
                        ...
                        Debug.LogWarning($"[{MOD_NAME}] (NineDragons) Cannot add {buffName}, prefab not cached or found.");
                ...
                // [V3.6 修复] 检查是否包含 1092
                if (new HashSet<string>(_nineDragonsBuffNames).IsSupersetOf(
                    new HashSet<string> { "1018_Buff_HealForWhile", "1011_Buff_AddSpeed", "1017_Buff_InjectorRecoilControl", "1012_Buff_InjectorMaxWeight", "1013_Buff_InjectorArmor", "1092_Buff_Injector_HotBlood_Trigger", "1084_Buff_PainResistLong", "1201_Buff_NightVision", "1014_Buff_InjectorStamina" }
                ))
                {
        ...
        private async UniTask TriggerBuffAsync(string buffName, KeyCode key)
        {
            ...
            try
            {
                ...
                // 【核心修正区域 Start】
                // [V3.6 修复] 检查缓存，如果失败则尝试手动查找
                if (!_buffPrefabCache.TryGetValue(buffName, out buffPrefab))
                {
                    Debug.LogWarning($"[{MOD_NAME}] Buff '{buffName}' not found in cache. Attempting manual resource scan.");
                    Buff[] allBuffs = Resources.FindObjectsOfTypeAll<Buff>();
                    buffPrefab = allBuffs.FirstOrDefault(b => b != null && b.name == buffName && b.gameObject.scene.name == null);
                }
                ...
                if (buffPrefab == null)
                {
                    Debug.LogError($"[{MOD_NAME}] Trigger failed! Buff '{buffName}' cound not be located in cache or resources.");
                ...
                if (_hardcoreModeConfig)
                {
                    ...
                    {
                        var findConsumeResult = await FindAndConsumeHardcoreItemAsync(itemID, mainCharacter, true);

                        if (!findConsumeResult.Item1)
                        {
            ...
            finally { _buffSequenceRunning[buffName] = false; }
        }
            ...
            try
            {
                ...
                foreach (Item injectorRef in injectorsToProcess)
                {
                    ...
                    if (_itemIdToBuffNameMap.TryGetValue(currentInjectorInstance.TypeID, out string buffName) && buffName != null)
                    {
                        ...
                        {
                            // 如果缓存失败，尝试实时查找
                            Debug.LogWarning($"[{MOD_NAME}] (扎包) Buff '{buffName}' not in cache, attempting fallback scan...");
                            Buff[] allBuffs = Resources.FindObjectsOfTypeAll<Buff>();
                            buffPrefab = allBuffs.FirstOrDefault(b => b != null && b.name == buffName && b.gameObject.scene.name == null);
                        }
        ...
        /// </summary>
        private async UniTask<ValueTuple<bool, Item, object, string>> FindAndConsumeHardcoreItemAsync(int itemID, CharacterMainControl mainCharacter, bool consume)
        {
            if (itemID <= 0) return (true, null, null, "无需消耗");
            ...
            if (mainInventory != null)
            {
                ...
                if (item != null)
                {
                    if (processFoundItem(mainInventory, item, "玩家背包"))
                        return (true, item, mainInventory, "玩家背包");
                }
                ...
                foreach (var pouch in pouches)
                {
                    ...
                    if (sc != null)
                    {
                        ...
                        {
                            Item itemInSlot = slot.Content;
                            if (processFoundItem(sc, itemInSlot, "玩家收纳包"))
                                return (true, itemInSlot, sc, "玩家收纳包");
                        }
                    }
                }
            }
            ...
            if (petInventory != null)
            {
                ...
                if (item != null)
                {
                    if (processFoundItem(petInventory, item, "宠物背包"))
                        return (true, item, petInventory, "宠物背包");
                }
                    ...
                    if (sc != null)
                    {
                        ...
                        if (slot?.Content != null)
                        {
                            ...
                            if (processFoundItem(sc, itemInSlot, "宠物收纳包"))
                                return (true, itemInSlot, sc, "宠物收纳包");
                        }
                    }
                }
            }
        ...
        private async UniTask<ValueTuple<Item, Inventory, string>> FindPouchAndParentInventoryAsync(CharacterMainControl mainCharacter)
        {
            ...
            Inventory petInv = await FindPetInventoryAsync(mainCharacter);
        ...
        {
            Debug.Log($"[{MOD_NAME}] Config Loaded - HoldTime: {_holdDurationConfig}s | Hardcore: {_hardcoreModeConfig} | InstantNineDragons: {_instantNineDragonsConfig} | PouchKey: {_pouchUseKeyCode} | Buff Hotkeys: {_buffKeyMap.Count} | NineDragons Buff Count: {_nineDragonsBuffNames.Count}");
        }
    }
}